...
const blogPosts = [
  ...
  { slug: "llm-loops-production-ai-products",       title: "Loops Engineering for Product Development: How to Increase AI Efficiency",                    excerpt: "The best AI products aren't the ones that make the most LLM calls, they're the ones that make the fewest calls needed to get the job done. A breakdown of the loop patterns behind production AI products, what they actually cost in tokens, and how to keep them efficient at scale.", image: "/lovable-uploads/llm-loops-banner.svg" },
];
