...
const socials = [
  ...
  },
  {
    label: 'RSS feed',
    href: '/index.xml',
    color: 'bg-[#ee802f] hover:opacity-80',
    icon: (
      <svg width="17" height="17" viewBox="0 0 24 24" fill="white">
    ...
    <div className="fixed bottom-6 right-5 z-50 flex flex-col items-center gap-2.5">
      ...
      >
        {open ? (
          ...
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" className="text-white dark:text-black" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
