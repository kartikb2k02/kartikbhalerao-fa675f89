...
export const CalComBooking: React.FC<CalComBookingProps> = ({
  ...
  return (
    <div className="bg-white dark:bg-white/[0.03] border border-black/8 dark:border-white/8 rounded-3xl overflow-hidden shadow-sm flex flex-col">
      ...
      <div className="px-8 py-7 flex flex-col gap-6 flex-1">
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="grid grid-cols-2 gap-2">
            {callTopics.map(({ label, icon: Icon }) => (
              <div key={label}
                className="flex items-center gap-2.5 px-3 py-2.5 rounded-xl border bg-black/[0.02] dark:bg-white/[0.03] border-black/8 dark:border-white/8"
              >
                <div className="w-6 h-6 rounded-lg bg-black/[0.05] dark:bg-white/[0.06] flex items-center justify-center shrink-0">
        ...
        <div className="space-y-3">
          <button
            ...
            className="group w-full flex items-center justify-center gap-2.5 py-3.5 px-5 rounded-xl bg-black dark:bg-white text-white dark:text-black text-[14px] font-semibold hover:opacity-85 active:scale-[0.99] transition-all duration-150 focus-visible:outline-none"
          >
            Pick a time
