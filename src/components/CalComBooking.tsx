    ...
    <div className="bg-white dark:bg-white/[0.03] border border-black/10 dark:border-white/10 flex flex-col">
      ...
      <div className="px-8 pt-7 pb-5 border-b border-black/[0.06] dark:border-white/[0.06] flex items-start justify-between">
        ...
        <div className="label-mono flex items-center gap-1.5 mt-0.5 px-2.5 py-1 bg-emerald-50 dark:bg-emerald-500/10 border border-emerald-200/60 dark:border-emerald-500/20 shrink-0">
          ...
          <span className="text-[10px] text-emerald-700 dark:text-emerald-400 whitespace-nowrap">Available</span>
        </div>
      </div>
      ...
      <div className="px-8 py-7 flex flex-col gap-6 flex-1">
        ...
        <div className="space-y-3">
          <button
            ...
            className="label-mono group w-full flex items-center justify-center gap-2.5 py-3.5 px-5 bg-black dark:bg-white text-white dark:text-black text-[13px] hover:opacity-80 active:scale-[0.99] transition-all duration-150 focus-visible:outline-none"
          >
            Pick a time
